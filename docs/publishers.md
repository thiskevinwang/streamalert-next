...
Publishers are executed in series, each passing its published `Alert` to
...
The `publishers` argument is a structure containing references to
...
By default, the PagerDuty integration sends
